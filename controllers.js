...
data="<div class='checkboxd-div"+num+"'><label>"+val.name+"</label><span><input type='checkbox'value='"+val.name+"'name="+val.name+" class='input0"+num+"'></span></div>";
